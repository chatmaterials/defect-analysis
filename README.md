...
Standalone skill for defect-focused DFT result analysis, including automatic defect-type inference, multi-species chemical-potential support, and mode-specific multi-candidate screening.
